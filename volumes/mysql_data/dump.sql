...
CREATE DATABASE `ejabberd` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `ejabberd`;
...
CREATE TABLE `mqtt_pub` (
  ...
  `response_topic` text COLLATE utf8mb4_unicode_ci NOT NULL,
